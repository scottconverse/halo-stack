...
- [ ] `steps/fresh_session_start.sh` — Start a new dsh --profile headless session (cold context = maximum room: ~120K usable of the 131,072 window after the ~10K boot prefix); write room.json from its measured pressure.
